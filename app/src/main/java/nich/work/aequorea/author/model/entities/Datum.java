...
public class Datum {
    ...
    private List<Object> mAnonymousPurchases;
    ...
    private List<EditorChoiceComment> mEditorChoiceComments;
    @SerializedName("id")
    private Long mId;
    ...
    public List<Object> getAnonymousPurchases() {
        return mAnonymousPurchases;
    }

    public void setAnonymousPurchases(List<Object> anonymousPurchases) {
    ...
    public List<EditorChoiceComment> getEditorChoiceComments() {
        return mEditorChoiceComments;
    }

    public void setEditorChoiceComments(List<EditorChoiceComment> editorChoiceComments) {
