...
// Base on MySplash.SwipeBackCoordinatorLayout {https://github.com/WangDaYeeeeee/Mysplash}
public class SwipeBackCoordinatorLayout extends CoordinatorLayout {
    ...
    public boolean onStartNestedScroll(View child, View target, int axes) {
            return super.onStartNestedScroll(child, target, axes) || ((axes & ViewCompat.SCROLL_AXIS_VERTICAL) != 0);
    }
